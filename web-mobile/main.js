(function () {
    ...
    function boot () {
        ...
        function setLoadingDisplay () {
            ...
            var progressL = document.getElementById('pro_l');
            var percent = 15;
            cc.loader.onProgress = function (completedCount, totalCount, item) {
                if (parseInt(100*completedCount/totalCount-percent)<50&&parseInt(100*completedCount/totalCount-percent)>0) {
                    percent = 100 * completedCount / totalCount;
                    if (progressBar) {
                        progressBar.style.width = percent.toFixed(2)*1.02 + '%';
                        progressL.innerHTML = parseInt(percent) + '%';
                    }
                }
                else{
                    percent+=5;
